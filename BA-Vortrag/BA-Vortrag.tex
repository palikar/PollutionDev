...
\begin{frame}
  \frametitle{Trainieren}
    ...
    \item  Loss Functions -- Wahrscheinlichkeitsverteilungen (Proper Scoring Rules).
    \end{itemize}
...
\begin{frame}
  \frametitle{Evaluierung der Modelle}
  \begin{itemize}
  \item keine Punktschätzung, sondern Wahrscheinlichkeitsverteilung
    \includegraphics[scale=0.5]{images/graph_2}
  \item Proper Scoring Rules -- Evaluierung der vorhergesagten Wahrscheinlichkeitsverteilungen.
  \end{itemize}
\end{frame}
